...
public class TelaCursoProfessores extends JFrame {
    ...
    public TelaCursoProfessores(TelaHome tela) {
        this.home = tela;
    ...
    public void initComponents() {
        ...
        labelTitulo = new JLabel("Professores do curso");
	    ...
	    tableModel = new DefaultTableModel(
                new Object[][] {},
                new String[] { "Nome", "Email", "CPF", "Disciplina"}
        ) {
            @Override
    ...
    private void comboBoxCursoActionListener(ActionEvent e) {
        ...
        labelTitulo.setText("Professores do curso - " + curso);
        List<Professor> professors = curso.getProfessores();
        
        professors.forEach(a-> {
        	tableModel.addRow(new Object[] { a.getNome(), a.getEmail(), a.getCpf(), a.getDisciplina() });
        });
